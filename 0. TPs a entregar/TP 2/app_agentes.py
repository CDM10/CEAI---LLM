...
def main():
    ...
    st.set_page_config(
        page_title="Chatbot Cristian Marino - TP 2",
        page_icon="🤖",
        #layout="wide"
    )

    # El título y mensaje de bienvenida de la aplicación Streamlit
    st.title("Chatbot de Cristian")
    st.write("¡Hola! Este es un chatbot sobre los CVs de Cristian y su traumatólogo. Pregunta lo que quieras!")
